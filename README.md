...
Project done during **ALX Software Engineering Scholarship 2022** at **Alx Students Education**. It aims to learn about what is a binary tree, the different traversal methods to go through a binary tree and the different types of binary trees (complete, full, perfect and balanced).
...
| `133-heap_extract.c` | Function that convert a Max Binary Heap to a sorted array on integers |
| `134-heap_to_sorted_array.c` | Function that converts a Max Binary Heap to a sorted array of integers |
